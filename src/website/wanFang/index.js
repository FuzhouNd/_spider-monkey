...
function queryAll(selector = '', document) {
    // @ts-ignore
...
async function get(name) {
    ...
    const frame1 = await createPage('http://www.baidu.com', 'pp1pp');
    // urlPrefix + encodeURIComponent(JSON.stringify(a))
